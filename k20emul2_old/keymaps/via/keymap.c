 ...
 */
     ...
     * └───────┴───┘───┘
     */
    // [WIN_FN] = LAYOUT(KC_CALC, KC_R,    NK_TOGG, KC_TRNS,
    //                 KC_TRNS,   KC_TRNS, KC_TRNS, KC_F9, 
    //                 BL_TOGG,   BL_STEP, RGB_TOG, KC_TRNS, 
    //                 BL_INC,    KC_TRNS, RGB_HUI, 
    //                 BL_DEC,    RGB_MOD, RGB_HUD, QK_BOOT, 
    //                 KC_TGUI,           KC_TRNS)

    [WIN_FN] = LAYOUT(KC_CALC, KC_R,    NK_TOGG, KC_TRNS, BL_DEC, BL_STEP, BL_INC, 
                    KC_TRNS,   KC_TRNS, KC_TRNS, KC_F9, 
                    BL_TOGG,   BL_STEP, RGB_TOG, KC_TRNS, 
                    BL_INC,    KC_TRNS, RGB_HUI, 
                    BL_DEC,    RGB_MOD, RGB_HUD, QK_BOOT, 
    ...
    */
    [MAC_BASE] = LAYOUT(KC_1,  KC_2,  KC_3,   MO(3), KC_VOLD, KC_MUTE, KC_VOLU, 
                        KC_F1, KC_F2, KC_F3, KC_F4, 
                        KC_LGUI,    KC_LALT,   KC_RGUI,    KC_RALT,
                        KC_Z,    KC_X,   KC_C, 
                        KC_R,    KC_T,   KC_Y, KC_ENTER, 
                        KC_LWIN,          KC_PDOT),
                        
    [MAC_FN] = LAYOUT(KC_U, KC_I,    KC_O, KC_TRNS, BL_DEC, BL_STEP, BL_INC,
                    KC_BRID, KC_BRIU, KC_MCTL, KC_LPAD, 
                    KC_LOPTN,   KC_LCMMD, KC_ROPTN,   KC_RCMMD, 
                    KC_Z,    KC_TRNS, KC_SLSH
                    , 
                    BL_DEC,    RGB_MOD, RGB_HUD, QK_BOOT, 
                    KC_TGUI,           KC_TRNS)               
